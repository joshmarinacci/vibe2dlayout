...
function addRect(state: AppState, x: number, y: number, w = 100, h = 50): { state: AppState; id: string } {
  ...
  const s2 = appReducer(s, { type: 'SET_TRANSFORM', id: shape.id, transform: { x, y, width: w, height: h, rotation: 0 } })
