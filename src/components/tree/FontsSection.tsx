        ...
        <div>
            <div className={styles.header}>
                ...
                <div className={styles.addBtnWrap}>
                    <button className={styles.addBtn} onClick={openMenu} title="Add Google Font">+
                    </button>
                    {showAddMenu && (
                        <div className={styles.addMenu}>
                            ...
                            <div className={styles.addActions}>
                                <button className={styles.cancelBtn} onClick={cancel}>Cancel
                                </button>
                                <button className={styles.confirmBtn} onClick={() => void confirm()}
                                        disabled={validating}>
                    ...
                    : customFonts.map(font => (
                        ...
                        >
                            ...
                            <button
                                ...
                                onClick={e => {
                                    e.stopPropagation();
                                    dispatch({type: 'DELETE_CUSTOM_FONT', fontName: font.name})
                                }}
                            >×
                            </button>
                        </div>
