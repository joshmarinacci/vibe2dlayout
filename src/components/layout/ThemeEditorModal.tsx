...
import {Check, Copy, Lock, Plus, Trash2, X} from 'lucide-react'
...
export function ThemeEditorModal() {
    ...
    return (
        <div
            ...
            onClick={e => {
                if (e.target === e.currentTarget) dispatch({type: 'TOGGLE_THEME_MODAL'})
            }}
        >
                        ...
                        <div className={styles.themeEditor}>
                            ...
                            <div className={styles.fieldRow}>
                                ...
                                <input
                                    ...
                                    onChange={e => {
                                        ...
                                        if (!isNaN(v)) updateTheme({borderWidth: v})
                                    }}
                                />
                            ...
                            <div className={styles.fieldRow}>
                                ...
                                <input
                                    ...
                                    onChange={e => {
                                        const v = parseFloat(e.target.value);
                                        if (!isNaN(v)) updateTheme({borderRadius: v})
                                    }}
                                />
                                <span className={styles.unit}>px</span>
                            </div>
                            ...
                            <div className={styles.fieldRow}>
                                ...
                                <input
                                    ...
                                    onChange={e => {
                                        const v = parseFloat(e.target.value);
                                        if (!isNaN(v)) updateTheme({fontSize: v})
                                    }}
                                />
                                <span className={styles.unit}>px</span>
                            </div>
                            ...
                            <div className={styles.fieldRow}>
                                ...
                                <label className={styles.toggleLabel}>
                                    ...
                                    />
                                    <span
                                        className={styles.toggleText}>{selectedTheme.handDrawn ? 'Rough / sketchy' : 'Plain / clean'}</span>
                                </label>
                            </div>
