      ...
      <div className={styles.modal} onClick={e => e.stopPropagation()}>
          ...
          <div className={styles.row}>
            ...
            <div className={styles.control}>
              ...
              <input
                ...
                value={pinchSlider}
                onChange={e =>
                  dispatch({ type: 'UPDATE_SETTINGS', patch: { pinchZoomSpeed: Number(e.target.value) / 1000 } })
                }
          ...
          <div className={styles.row}>
            ...
            <div className={styles.control}>
              ...
              <input
                ...
                value={wheelPct}
                onChange={e =>
                  dispatch({ type: 'UPDATE_SETTINGS', patch: { wheelZoomStep: Number(e.target.value) / 100 } })
                }
                className={styles.slider}
              />
        ...
        <div className={styles.footer}>
          <button
            ...
            onClick={() => dispatch({ type: 'UPDATE_SETTINGS', patch: { ...DEFAULT_SETTINGS } })}
          >
            <RotateCcw size={13} />
            Reset to defaults
          </button>
