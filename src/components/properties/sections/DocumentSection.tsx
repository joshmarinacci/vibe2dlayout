...
export function DocumentSection({ documentName, documentId, gridSettings, activeThemeName, dispatch }: Props) {
  return (
    <>
      <div className={styles.section}>
        ...
        <div className={styles.nameRow}>
          <input
            ...
            onChange={e => dispatch({ type: 'SET_DOCUMENT_META', id: documentId, name: e.target.value })}
          />
        </div>
      </div>
      ...
      <div className={styles.section}>
        ...
        <ToggleInput
          ...
          onChange={v => dispatch({ type: 'UPDATE_GRID_SETTINGS', patch: { snapEnabled: v } })}
        />
        <NumberInput
          label="Grid Size"
        ...
        <div className={styles.row}>
          ...
          <select
            ...
            onChange={e => dispatch({ type: 'UPDATE_GRID_SETTINGS', patch: { style: e.target.value as GridStyle } })}
            style={{ fontSize: 12 }}
          >
